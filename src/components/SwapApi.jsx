...
<div  className="grid md:grid-cols-2 lg:grid-cols-3 gap-10  py-5 my-5 w-full text-white "> 
  ...
  <h1 className="font-bold text-2xl"  key={films.title}>{films.title}</h1>
          ...
          <p key={films.opening_crawl} className="w-full text-base  my-3">{films.opening_crawl.slice(0, 200)}...</p>
          
          <div  className="bg-red-500 my-5 w-full h-[2px]"/> 
          <a  href="/"  className="text-yellow-500">More Info</a>
    </div>       
